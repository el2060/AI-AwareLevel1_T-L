...
export function openingVisual() {
  const areas = [
    { title: "Curriculum Design and Development", detail: "How AI is reshaping the competencies your students need as professional practice changes.", iconName: "BookOpen" },
