...
function ThreeAsMisconceptionCheck() {
  return <ScenarioSorter
    ...
    scenarios={[
      ...
      { id: "no-change", context: "A module may emphasise one, two or all three of the 3As, and the review may conclude that no change is needed.", answer: "Accurate", feedback: "The relevant emphasis depends on the discipline, module level, intended learning outcomes and professional context." },
...
function GenAiConditionsSorter() {
  return <ScenarioSorter
    ...
    scenarios={[
      ...
      { id: "declared", context: "A student submits a fully AI-generated report and declares the AI use on the cover page.", answer: "Prohibited", feedback: "Declaring AI use does not make a fully AI-generated submission acceptable. Students must still demonstrate the learning and contribution required by the assessment. AI may be used where permitted, but it should not substitute for the student's own achievement of the learning outcomes." },
    ...
    <details className="policy-detail student-baseline-accordion">
      ...
      <div>
        <div className="baseline-intro">
          ...
          <p className="baseline-refer">
            The summary below highlights the key ideas and NP context. Refer to the{" "}
            <a href="https://nplms.polite.edu.sg/d2l/le/lessons/998763/topics/14624182" target="_blank" rel="noopener noreferrer">full sector AI baseline competencies and learning outcomes</a>{" "}
            for the detailed competency statements and descriptors.
          </p>
        </div>
